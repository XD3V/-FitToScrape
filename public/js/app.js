...
$(document).ready( () => {
    ...
    // also, "scrape new article" buttons
    // and create a clear mechnic to clear each article.
    let articleContainer = $(".articleContainer");
    $(document).on("click", ".btn.save", articlesSaved);
    $(document).on("click", ".scrape-new", theArticleScraper);
    $(".clear").on("click", clearTheArticle);
